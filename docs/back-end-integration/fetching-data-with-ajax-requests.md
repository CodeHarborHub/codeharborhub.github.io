...
<BrowserWindow>
     <div id="output_element3" style={{display:"none"}}>
     <h2>Fetched Data</h2>
     <p id="load_ing" style={{fontFamily:"monospace",textAlign:'center',fontWeight:"600",fontSize:"1.2rem"}}>Fetching....</p>
     <ul id="u_l"></ul>   
     </div>
     <button id="hide_btn3" onClick={()=>{
      let output_element3=document.getElementById("output_element3")
      output_element3.style.display="block"
      let hide_btn3=document.getElementById("hide_btn3")
      hide_btn3.style.display="none"
      setTimeout(()=>{ 
               let ele = document.getElementById("load_ing");
              if (ele) {
     ...
     }}>click to see the output</button>
</BrowserWindow>
