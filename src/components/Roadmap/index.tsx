...
const techCategories: TechCategory[] = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { id: 103, name: "Scikit-learn", link: "#" },
      { id: 104, name: "Keras", link: "#" },
      { id: 105, name: "Pandas", link: "#" },
      { id: 106, name: "NumPy", link: "#" },
      { id: 107, name: "Matplotlib", link: "#" },
      { id: 108, name: "Seaborn", link: "#" },
      { id: 109, name: "NLTK", link: "#" },
      { id: 110, name: "OpenCV", link: "#" },
      { id: 111, name: "XGBoost", link: "#" },
      { id: 112, name: "LightGBM", link: "#" },
      { id: 113, name: "CatBoost", link: "#" },
      { id: 114, name: "H2O.ai", link: "#" },
      { id: 115, name: "Apache Spark", link: "#" },
      { id: 116, name: "Apache Flink", link: "#" },
      { id: 117, name: "Hadoop", link: "#" },
    ],
  },
];
